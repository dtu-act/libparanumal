...
#BSUB -o "/work3/nibor/data/logs/libparanumal_Lshape_test_%J_%I.out"
#BSUB -e "/work3/nibor/data/logs/libparanumal_Lshape_test_%J_%I.err"
...
SAMPLE_LIST=($(<simulationSetups/deeponet/setup_test_srcpos_fixed/Lshape/joblist.list))
