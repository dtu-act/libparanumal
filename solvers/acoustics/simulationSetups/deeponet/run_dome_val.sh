...
#BSUB -o "/work3/nibor/data/logs/libparanumal_dome_val_%J_%I.out"
#BSUB -e "/work3/nibor/data/logs/libparanumal_dome_val_%J_%I.err"
...
# Run solver
mpirun -np 1 ./acousticsMain simulationSetups/deeponet/setup_train_val_srcpos_mesh/setup_dome_val $src_index
