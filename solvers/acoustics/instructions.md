...
2. Create a folder `libparanumal` and clone the code from git into the folder using the command <br>
...
4. Build OCCA and libParanumal by running <br>
    `> ./libparanumal/solvers/acoustics/build_acoustics.sh`. <br>
